...
/**
 * A Lemon tree class with a method to "pick" a lemon. The "size" of the lemon is randomized and determines
 * how many times a lemon needs to be squeezed before you get lemonade. */
class LemonTree {
    fun pick(): Int {
        return (2..4).random()
    }
